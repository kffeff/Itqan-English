...
st.markdown(
"<h1 style='text-align:center;color:#007bff'>منصة إتقان اللغة الإنجليزية</h1>",
unsafe_allow_html=True
)
...
# =========================
    ...
    if data["categories"]:
        ...
        st.info(
        "لا توجد وحدات دراسية بعد. استخدم لوحة الإدارة."
        )
